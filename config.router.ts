export default [
  ...
  export const menus = [ // 菜单的配置项，用于动态渲染 key:	唯一标志 title: 菜单项值 path：用于路由跳转
    ...
    { key:"antd",title:"antd组件",children:[
        ...
        { key: 'combination-cn', title: 'Tabs+Table', path: '/antdUI/combination' },
        { key: 'tree-cn', title: 'tree树', path: '/antdUI/tree-cn' },
        {
          key: 'upload', title: 'Upload上传',
          children: [
    ...
    { key: 'assembly-cn/select', title: 'assembly-select', path: '/assembly/select' },
