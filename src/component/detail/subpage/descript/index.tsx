...
const Descript: FC<IDescriptProps> = (props) => {
  ...
  return (
    <Descriptions
      column={2}
      size="default"
      contentStyle={{ fontFamily: 'emoji', lineHeight: '50px' }}
      labelStyle={{ textAlign: 'right', width: '70px', lineHeight: '50px' }}
    >
      ...
      <Descriptions.Item label="评价时间" span={2}>
        {dataSource?.evaluateTime}
      </Descriptions.Item>
    </Descriptions>
  );
};
