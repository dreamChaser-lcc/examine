...
export default () => {
  ...
  const columns = [
    { title: 'name1', className: 'name', dataIndex: 'name', key: 'name' },
    { title: 'age1', dataIndex: 'age', key: 'age' },
    { title: 'gender1', dataIndex: 'gender', key: 'gender' },
    {
      title: 'current1',
      dataIndex: 'current',
      key: 'current',
  ...
  const data = useMemo(() => {
    return [{ key: 1, name: '1', age: 2, gender: 1, current: tabKey }];
  }, [tabKey]);
